...
import { createOidcApplication } from '../support/auth.helper';
...
Then('I should see client credentials', async function (this: BouncrWorld) {
...
Then('I should see a new client secret', async function (this: BouncrWorld) {
