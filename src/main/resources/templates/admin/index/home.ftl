...
<@layout.layout "Home">
  ...
  <ul>
    <#if hasAnyPermissions(userPrincipal, "CREATE_USER", "MODIFY_USER", "DELETE_USER")>
    ...
    <#if hasAnyPermissions(userPrincipal, "CREATE_GROUP", "MODIFY_GROUP", "DELETE_GROUP")>
    <li><a href="${urlFor('net.unit8.bouncr.web.controller.GroupController', 'list')}"><i class="fa fa-users" aria-hidden="true"></i>Groups</a></li>
    </#if>
    <#if hasAnyPermissions(userPrincipal, "CREATE_APPLICATION", "MODIFY_APPLICATION", "DELETE_APPLICATION")>
    ...
    <#if hasAnyPermissions(userPrincipal, "CREATE_ROLE", "MODIFY_ROLE", "DELETE_ROLE")>
    ...
    <#if hasAnyPermissions(userPrincipal, "CREATE_PERMISSION", "MODIFY_PERMISSION", "DELETE_PERMISSION")>
