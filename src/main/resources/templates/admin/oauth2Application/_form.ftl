...
<div class="form-group<#if oauth2Application.hasErrors("description")> has-error</#if>">
  ...
  <input id="description" class="form-control<#if oauth2Application.hasErrors("description")> is-invalid</#if>" type="text" name="name" value="${oauth2Application.description!''}"/>
...
<div class="form-group<#if oauth2Application.hasErrors("homeUrl")> has-error</#if>">
  ...
  <input id="homeUrl" class="form-control<#if oauth2Application.hasErrors("homeUrl")> is-invalid</#if>" type="text" name="name" value="${oauth2Application.homeUrl!''}"/>
...
<div class="form-group<#if oauth2Application.hasErrors("callbackUrl")> has-error</#if>">
  ...
  <input id="callbackUrl" class="form-control<#if oauth2Application.hasErrors("callbackUrl")> is-invalid</#if>" type="text" name="name" value="${oauth2Application.callbackUrl!''}"/>
